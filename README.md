...
- **Mixed location call types** — location called as both func and gosub/goto/desc
...
| `qsp.diagnostics.mixedLocationCallTypes` | `true` | Info when location called as both func and gosub/goto/desc |
